...
class _ApartmentDetailsPageState extends State<ApartmentDetailsPage> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text("${apt.governorate}, ${apt.city}", style: const TextStyle(color: Colors.grey)),
                      ),
                    ],
                  ),
                  ...
                  if (apt.addressDetails != null)
                    Padding(
                      ...
                      child: Text(apt.addressDetails!, style: TextStyle(color: Colors.grey[600], fontSize: 13)),
                    ),
                  ...
                  const SizedBox(height: 30),
                  // قسم اختيار التاريخ
                  const Text("Reservation Period", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 10),
                  _buildBookingCard(),
  ...
  Future<void> _handleBooking() async {
    ...
    // تأكد من أن التواريخ ليست فارغة أو `null`
    String startDate = _selectedDateRange!.start.toIso8601String();
    String endDate = _selectedDateRange!.end.toIso8601String();
    ...
    if (result['success']) {
      ...
      String errorMsg = result['message'] ?? "This date is already taken.";
